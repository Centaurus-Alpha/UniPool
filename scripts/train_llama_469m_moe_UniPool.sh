...
set -euo pipefail
####
# UniPool 469m: All MoE layers share one global expert pool with per-layer routers.
...
PROJECT_NAME=${9:-"unipool-469m-${NUM_EXPERTS}e${LAYERS_TAG}${TOPK_TAG}${ROUTER_TAG}${LAYER_AUX_TAG}${POOL_AUX_TAG}${POOL_SIZE_TAG}-cc"}
