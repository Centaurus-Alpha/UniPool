# Upstream Megatron Core Changelog

This file preserves the NVIDIA Megatron-LM release history from the upstream
project. UniPool changes are not yet versioned and are not tracked here. For
the UniPool-specific surface, see [README.md](README.md) and
[NOTICE](NOTICE).
